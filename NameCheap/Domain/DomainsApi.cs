...
public class DomainsApi : IDomainsApi
{
    ...
    private readonly ILogger<DomainsApi> _logger;

    public DomainsApi(NamecheapClient client, ILogger<DomainsApi> logger)
    {
        _client = client;
        _logger = logger;
    }
    ...
    // internal DomainsApi(IOptions<NamecheapOptions> namecheapOptions)
    // {
    //     _params = namecheapOptions?.Value ?? throw new ArgumentNullException(nameof(namecheapOptions));
    // }
    //
    // /// <summary>
    ...
    // /// </exception>
    // public async Task<DomainCheckResult[]> AreAvailable(params string[] domains)
    // {
    //     var queryTask = new NamecheapClient(_params)
    //         .AddParameter("DomainList", string.Join(",", domains))
    //         .ExecuteAsync("namecheap.domains.check");
    //
    ...
    // /// </exception>
    // public async Task<DomainCreateResult> Create(DomainCreateRequest domain)
    // {
    //     var query = new NamecheapClient(_params);
    //
    //     foreach (var item in GetNamesAndValuesFromProperties(domain))
    //         query.AddParameter(item.Key, item.Value);
    //
    //     var doc = await query.ExecuteAsync("namecheap.domains.create");
    //     var result = doc.Root.Element(_ns + "CommandResponse").Element(_ns + "DomainCreateResult");
    //
    ...
    // /// </exception>
    // public async Task<DomainContactsResult> GetContacts(string? domain)
    // {
    //     var doc = await new NamecheapClient(_params)
    //         .AddParameter("DomainName", domain)
    //         .ExecuteAsync("namecheap.domains.getContacts");
    //
    ...
    // /// </exception>
    // public async Task<DomainInfoResult> GetInfo(string? domain)
    // {
    //     var doc = await new NamecheapClient(_params)
    //         .AddParameter("DomainName", domain)
    //         .ExecuteAsync("namecheap.domains.getInfo");
    //
    //     var root = doc.Root!.Element(_ns + "CommandResponse")!.Element(_ns + "DomainGetInfoResult")!;
    //
    ...
    // {
    //     var doc = await new NamecheapClient(_params).ExecuteAsync("namecheap.domains.getList");
    //
    ...
    // /// - 5050900	Unknown exceptions
    // /// </exception>
    // public async Task<bool> GetRegistrarLock(string? domain)
    // {
    //     var doc = await new NamecheapClient(_params)
    //         .AddParameter("DomainName", domain)
    //         .ExecuteAsync("namecheap.domains.getRegistrarLock");
    //
    //     var root = doc.Root.Element(_ns + "CommandResponse").Element(_ns + "DomainGetRegistrarLockResult");
    ...
    // {
    //     new NamecheapClient(_params)
    //         .AddParameter("DomainName", domain)
    //         .ExecuteAsync("namecheap.domains.setRegistrarLock");
    // }
    //
    // /// <summary>
    ...
    // /// - 3050900	Unknown response from provider
    // /// </exception>
    // public async Task<TldListResult> GetTldList()
    // {
    //     var doc = await new NamecheapClient(_params).ExecuteAsync("namecheap.domains.getTldList");
    //
    ...
    // /// </exception>
    // public async Task<DomainRenewResult> Renew(string? domain, int years)
    // {
    //     var doc = await new NamecheapClient(_params)
    //         .AddParameter("DomainName", domain)
    //         .AddParameter("Years", years.ToString())
    //         .ExecuteAsync("namecheap.domains.renew");
    //
    ...
    // /// - 2515610	Premium price is incorrect. It should be (premium renewal price value).
    // /// </exception>
    // public async Task<DomainReactivateResult> Reactivate(string? domain)
    // {
    //     var doc = await new NamecheapClient(_params)
    //         .AddParameter("DomainName", domain)
    //         .ExecuteAsync("namecheap.domains.reActivate");
    //
    ...
    //         query.AddParameter(item.Key, item.Value);
    //
    //     var doc = query.ExecuteAsync("namecheap.domains.setContacts");
    // }
    ...
    {
        var doc = await _client.ExecuteAsync("namecheap.domains.getList", ctx);
